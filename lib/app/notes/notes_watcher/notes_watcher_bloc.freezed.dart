...
/// @nodoc
abstract class _$$DataTransferInProgressImplCopyWith<$Res> {
  factory _$$DataTransferInProgressImplCopyWith(
          _$DataTransferInProgressImpl value,
          $Res Function(_$DataTransferInProgressImpl) then) =
      __$$DataTransferInProgressImplCopyWithImpl<$Res>;
}

/// @nodoc
class __$$DataTransferInProgressImplCopyWithImpl<$Res>
    extends _$NoteWatcherStateCopyWithImpl<$Res, _$DataTransferInProgressImpl>
    implements _$$DataTransferInProgressImplCopyWith<$Res> {
  __$$DataTransferInProgressImplCopyWithImpl(
      _$DataTransferInProgressImpl _value,
      $Res Function(_$DataTransferInProgressImpl) _then)
      : super(_value, _then);
}

/// @nodoc

class _$DataTransferInProgressImpl implements DataTransferInProgress {
  const _$DataTransferInProgressImpl();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DataTransferInProgressImpl);
  }
...
abstract class DataTransferInProgress implements NoteWatcherState {
  const factory DataTransferInProgress() = _$DataTransferInProgressImpl;
}
...
abstract class LoadSuccess implements NoteWatcherState {
  const factory LoadSuccess(final KtList<Note> notes) = _$LoadSuccessImpl;
...
abstract class LoadFailure implements NoteWatcherState {
  const factory LoadFailure(final NoteFailure noteFailure) = _$LoadFailureImpl;
